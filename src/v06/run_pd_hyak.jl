...
using JLD2
#using Limbdark
include("../Limbdark/src/integrate_lightcurve.jl")
...
#            read(stdin,Char)
#          end
          phot_vary[i1[ifile]:i2[ifile]] .= fit_poly(tcurr,phot[i1[ifile]:i2[ifile]]./phot_mod[i1[ifile]:i2[ifile]],3)
        end
...
#= Example:
 datafile = "../../data/T1_Spitzer_data.jld2"; foutput = "T1_pd_MCMC_v01.jld2"; numwalkers = 50; burnin = 10; thinning = 1; astep = 2.0; nsteps = 50
