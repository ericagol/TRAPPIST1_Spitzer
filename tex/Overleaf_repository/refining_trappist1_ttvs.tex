...
\documentclass[fleqn,usenatbib]{mnras} % https://www.overleaf.com/project/5e22241aad2a0b00016288df
...
\title[T1 masses, radii, densities]{Refining the transit timing and photometric 
...
\author[Agol et al.]{
E. Agol,$^{1}$\thanks{E-mail: agol@uw.edu} %[x]
E. Bolmont,$^{2}$ %[x]
A. Burgasser,$^{3}$ %[x]
A. Burdanov,$^{4}$ %[x]
S. Carey,$^{5}$ %[x]
L. Delrez,$^{6,7,2}$
\newauthor B.-O. Demory,$^{8}$ %[x]
J. de Wit,$^{4}$ %[x]
C. Dorn,$^{16}$ %[x]
E. Ducrot,$^{6}$ %[x]
D. Fabrycky,$^{9}$ %[x]
D. Foreman-Mackey $^{17}$
\newauthor M. Gillon,$^{6}$ % [x]
S. L. Grimm,$^{8}$ %[x]
D. M. Hernandez,$^{10}$ %[x]
J. Ingalls,$^{5}$ %[x]
 E. Jehin,$^{7}$ %[x]
Z. Langford,$^{1}$ %[x]
\newauthor J. Leconte,$^{11}$ %[x]
S. M. Lederer,$^{12}$ %[x]
R. Malhotra,$^{13}$ %[x]
V. Meadows, $^1$
B. M. Morris,$^{8}$ %[x]
D. Queloz,$^{14}$ %[x]
\newauthor S.~N. Raymond,$^{11}$ %[x]
F. Selsis,$^{11}$ %[x]
M. Sestovic,$^{8}$ %[x]
A. H.M.J. Triaud,$^{15}$ %[x]
M. Turbet,$^{2}$ %[x]
\newauthor and V. Van Grootel$^{7}$ %[x]
\\
% List of institutions
$^{1}$Astronomy Department, University of Washington, Seattle, WA 98195 USA\\
%$^{2}$Observatoire astronomique de l'Université de Genève, 51 chemin de Pégase, 1290 Sauverny, Switzerland\\
...
$^{5}$IPAC, California Institute of Technology, 1200 E California Boulevard, Mail Code 314-6, Pasadena, California 91125, USA\\
$^{6}$Astrobiology Research Unit, Université de Liège, Alléee du 6 Août 19C, B-4000 Liège, Belgium\\
$^{7}$Space Sciences, Technologies and Astrophysics Research (STAR) Institute, Université de Liège, Allée du 6 Août 19C, B-4000 Liège, Belgium\\
$^{8}$Center for Space and Habitability, University of Bern, Gesellschaftsstrasse 6, CH-3012, Bern, Switzerland\\
$^{9}$Department of Astronomy \& Astrophysics, University of Chicago, 5640 S. Ellis Ave., Chicago, IL 60637 USA\\
$^{10}$Harvard–Smithsonian Center for Astrophysics, 60 Garden St., MS 51, Cambridge, MA 02138, USA\\
$^{11}$Laboratoire d'astrophysique de Bordeaux, Univ. Bordeaux, CNRS, B18N, Allée Geoffroy Saint-Hilaire, F-33615 Pessac, France\\
$^{12}$NASA Johnson Space Center, 2101 NASA Pkwy., Houston TX, 77058, USA\\
$^{13}$Lunar and Planetary Laboratory, The University of Arizona, Tucson, AZ 85721 USA\\
$^{14}$Cavendish Laboratory, JJ Thomson Avenue, Cambridge, CB3 0H3, UK \\
$^{15}$School of Physics \& Astronomy, University of Birmingham, Edgbaston, Birmimgham B15 2TT, UK\\
$^{16}$ University of Zurich, Institute of Computational Sciences, Winterthurerstrasse 190, CH-8057, Zurich, Switzerland \\
$^{17}$ Center for Computational Astrophysics, Flatiron Institute, Simons Foundation, 162 5th Ave., New York, NY 10010, USA
}
...
space telescope over three years.  We add to these ground-based, HST and K2 transit time
measurements, and revisit a transit-timing N-body dynamical analysis of the seven-planet system
using our complete set of times.  We find evidence of infrequent timing outliers, 
and treat these with a robust likelihood function. From the transit timing
analysis, we refine the masses of the planets relative to the star.  We additionally carry out a 
photodynamical analysis of the Spitzer light curve to derive the density of the host star and the
planet densities.  We find that all seven planets' densities can now be described with a single
mass-radius relation which has an iron mass fraction of about 17\%, volatile-free, and otherwise Earth-like 
in composition.  Alternatively, the planets may have an Earth-like iron/rock composition, but then also require an additional volatile enhancement, such as an outer water layer or a core-free structure with oxidized iron in the mantle.  The precisions of the planet masses in the seven-planet timing solution range from 3-5\%;  this is equivalent to 
being able to make radial-velocity semi-amplitude measurements with an uncertainty 2.5 cm/sec, 
which is two orders of magnitude more precise than current high-precision
spectroscopy measurements.  The eccentricities of the planets are very small,
and we discuss the dynamical state in light of simulations of the formation and
tidal evolution of the system.  We examine the long-term stability of the system;
the presence of additional planets; and possible implications
of the planet densities for the formation, migration and evolution
of the planets. 
\end{abstract}
...
\begin{keywords}
infrared: planetary systems -- planets and satellites: terrestrial planets -- planets and satellites: compositions -- planets and satellites: fundamental parameters
\end{keywords}
...
of only 50 nearby ultracool dwarf stars \citep{Jehin2011, Gillon2013}, suggesting either a high-frequency of such systems around the latest of the M-dwarfs \citep{He2016}, or perhaps this discovery was fortuitous \citep{Sestovic2020, sagear2019}.  
...
and has fueled hopes that atmospheric signatures (or even biosignatures) might be detected with the James Webb
Space Telescope \citep{Barstow2016, Morley2017, Batalha2018, Krissansen2018, Wunderlich2019, Fauchez2019a, Lustig-Yaeger2019}.  
...
the lowest-mass stars. In particular, transiting multi-planet systems afford an opportunity to constrain
the interior compositions of exoplanets.  Transit depths combined with transit-timing variations yield the densities of the planets \citep[e.g.][]{Agol2017}.
In the case of rocky planets with a
thin atmosphere, the bulk density can constrain the core-mass fraction and/or
Mg/Fe mass-ratio \citep{Valencia2007}, although for any given planet there is still a degeneracy between a larger core-mass fraction and a volatile envelope \citep{Dorn2018}.  In a multi-planet system,
the bulk density as a function of planet orbital distance may be used to break the compositional degeneracy \citep{Unterborn2018a}.
...
confusion, revealing the periods of six of the seven transiting planets \citep{Gillon2017}, but only a single transit observed
of the outermost planet let it's orbit in question.  A subsequent observation campaign of the system with the K2 spacecraft 
included four additional transits of the outer planet, identifying its period, and reveals a series
of generalized three-body Laplace relation (GLR) \footnote{This refers to the condition $pP_1^{-1}-(p+q)P_2^{-1}+qP_3^{-1} \approx 0$, which is a generalization of the Laplace resonance with $p=1$ and $q=2$ \citep{Papaloizou2014}. } between adjacent triplets of planets \citep{Luger2017a}.  Additional observations with Spitzer were scheduled to continue to monitor the transit times of the seven planets at higher precision than afforded by ground-based observations, for which an initial analysis of the planetary radii and masses was presented in \citet{Delrez2018a} and \citet{Grimm2018}. In total, Spitzer observed TRAPPIST-1 for more than 1000hrs, and the resulting time-series photometry includes 188 transits \citep{Ducrot2020}.
...
densities of the planets.   These measurements may be used for planetary science with extrasolar
planets in TRAPPIST-1, which by some measures are the most similar to the terrestrial planets in our Solar System as
far as size, mass, and current insolation are concerned.  In addition, we refine the dynamical
...
Telescope (JWST);  with more precise constraints on the parameters of the planets,
the forecast of JWST observations can help to better make use of observations of
the TRAPPIST-1 system with JWST.
...
Since the work described in \citet{Grimm2018}, we have added an 
additional 163 transit times from a combination of Spitzer
...
(\S \ref{sec:outliers}), which we account for in robust likelihood
...
In addition to the new Spitzer times, 125 transits were observed by the SPECULOOS-South Observatory \citetext{SSO, \citealt{Burdanov2018,Jehin2018}, \citealt{Gillon2018}, \citealt{Delrez2018b}} at Cerro Paranal, Chile and TRAPPIST (TRAPPIST-South at La Silla Chile, TS, and TRAPPIST-North at Oukaimeden Morocco, TN). These observations were carried out in an I+z filter with exposure 23s and 70s exposure time respectively; characteristics of this filter are described in \cite{Murray2020}. 
...
$\sigma_{ij}$ is the corresponding measurement error.
...
%\begin{figure}
%    \centering
%    \includegraphics[width=\hsize]{figures/timing_residuals_domprior_mixture_21April2019_color.png}
%    \caption{Timing residuals normalized by the standard deviation versus time
%    of transit for each planet.  Points are colored by the probability of being
%    drawn from the foreground model (green) versus background model (blue); background
%    indicates that the points are outliers. [This figure is out of date - based on
%    April 2019 analysis.]}
%    \label{fig:timing_residuals}
%\end{figure}
...
where $N_p$ is the number of planets for a total of $5N_p$ dyanamical parameters. In
...
The Laplace approximation analysis assumes a uniform prior on the model parameters and a likelihood which is
described by a multi-dimensional normal distribution with
covariance estimated by the inverse of the Hessian matrix at the
maximum likelihood.  We maximized the likelihood model using
the Levenberg-Marquardt algorithm, which uses the gradient
of the likelihood and the Hessian.  Once
we found the maximum likelihood, we compute an approximate Hessian of the maximum log likelihood in which we neglect the second derivatives of the
transit times with respect to the model parameters as these
terms tend to cancel and thus do not contribute significantly to the log likelihood (see Appendix \ref{sec:hessian}).

The inverse of this matrix gives the an estimate of the covariance amongst the
parameters at the maximum likelihood, whose diagonal components
provide an initial estimate for the parameter uncertainties,
and will also be used for more efficient sampling of the
Markov chain.

The second approach we used was to compute the likelihood
profile for each model parameter.  In this case each parameter
was varied over a grid of values over a range given
...
the grid for each parameter we optimized the likelihood with
...
The likelihood profile approach is useful for checking for 
...
nor for the prior probability distribution.
...
\begin{equation}
    \Pi(\mathbf{x}) = \prod_{i=1}^{N_p} e_i^{-1} {\times} \prod_{j=1}^{N_{param}} \Pi_\mathrm{bound}(x_j),
\end{equation}
where the values of $\xi_1{-}\xi_4$ for each parameter
$\mathbf{x} {=} \{x_j; j{=} 1,...,N_{param}\}$ are given in Table
\ref{tab:prior_parameterization}, where $N_{param} = 5 N_p + 2$.
...
\end{equation}
where $Z_n \sim N(0,1)$ is an element of a vector of random normal deviates for $n=1,...,N_{param}$.
We then carry out a leapfrog integration of Hamilton's equations for $N_\mathrm{leap}$ steps from the starting point with a "time" step $\epsilon$ to obtain a proposal set of parameters $(\mathbf{x}_{prop},\mathbf{p}_{prop})$.  Since energy is not conserved precisely due to the finite differencing of the leapfrog integration, we then apply a Metropolis rejection step to accept the proposal step with probability
\begin{equation}
    p_\mathrm{accept} = \mathrm{min}(\exp(-(H(\mathbf{x}_{prop},\mathbf{p}_{prop}) - H(\mathbf{x},\mathbf{p}))),1),
\end{equation}
...
\begin{figure*}
	%\includegraphics[width=\hsize]{figures/T1_TTV_complete.png}
...
we compute the sky velocity, $v_{sky}$, at each of the mid-transit times, $t_0$,
...
of $R_*/\mathrm{day}$.
We account for quadratic limb-darkening of the star with parameters ($q_{1,Ch1}, q_{2,Ch1},q_{1,Ch2},q_{2,Ch2}$), and for each
...
$0.25^\circ$.  The inclination prior also enables a more precise and symmetric 
...
of these two planets, the stellar density posterior is corresponding tighter, and 
...
\begin{figure*}
   ...
   \includegraphics[width=\hsize]{figures/Figure_MR_Dorn_v06.png}
...
proportional to the mass of the perturbing planet \citep{Agol2005,Lithwick2012}.
Hence, an interesting question to address is whether the transit timing
is solely due to the planets in the system.

We started with a "search" for the known planets by examining the companion times of transit.
We carried out a sequence
of transit-timing analyses in which we ignored the transits of one
of the seven planets.  We then re-fit the transiting planet model to
the remaining six planets to determine if the seventh "missing"
planet could be detected by measuring the timing variations of
the other six.
...
a single transit of planet h, a clue as to the orbital period of planet h was a
...
the possible existence of planets interior \citep{Pletser2017} and exterior
\citep{Kipping2018} to the seven known transiting planets.

%We can imagine applying the same procedure to the seven planets to search for
%an eighth planet. % There are several "orphan" transits which have been found
%which do not match up periodically with other features in the light curve
%\citep{Ducrot2020}.  However, it is
%possible that a more distant planet fails to transit the star, or that a
%transiting longer period planet happpens to fall in the gaps of our observations.
...
vector elements drawn from a random normal with width 0.005.   We
...
out 11,200 optimizations.

We then carried out a search for evidence of perturbations by planet i by
determining if the likelihood of the transiting planets could be improved
by adding in an eighth planet to the transit timing models, using
the Bayesian Information Criterion (BIC) to penalize the additional degrees
of freedom of the eight-planet model.  We searched for a change to BIC
for the eight-planet model over the seven-planet model with a difference
of better than $5\log{n_{trans}} = 30.5$.  Given that the inner seven
...
In all 11,200 trial cases we found that only two of the eight-planet models 
did meet the BIC criterion, but both significantly exceed an eccentricity
...
GLR with planets g and h.
We then examined the scatter in the resulting
masses of planets $b-h$ at the optimized 8-planet models, and found
scatters of $(0.025,0.008,0.006,0.008,0.007,0.006,0.0018) M_\oplus$ for
planet b-h, respectively, all of which are smaller than the uncertainties
on the Markov-chain model (Table \ref{tab:TTV_parameters}).  Hence, we 
conclude that the effect of an
eighth planet in a GLR does not significantly affect the
mass measurements of the inner seven transiting planets.
...
properties based upon the mass-radius relation we inferred in \S \ref{sec:mass_radius_relation}.

\subsection{Initial analysis of planet densities across the system}

The probability distribution for the masses and radii of the seven planets are shown in Figure \ref{fig:mass_radius_relation} along with several theoretical mass-radius relationships added for comparison. 
We have added three rocky mass-radius relationships with different bulk Fe/Mg compositions: (1) Fe/Mg$ = 0$ representing the rock composition of lowest density; (2) Fe/Mg$ =0.75$ as suggested by \citet{Unterborn2018a} to represent the rocky interior of all TRAPPIST-1 planets; and (3) the Earth-like value of Fe/Mg$ = 0.83$ \citep{Lodders2009}. Rocky interiors are calculated using the models of \citet{Dorn2016}. We have also added the theoretical mass-radius relationships for planets endowed with a water layer, both for planets which are irradiated less (blue line) and more (orange lines) than the runaway greenhouse irradiation threshold \citep{Turbet2020}.

The comparison of measured masses and radii with theoretical mass-radius relationships reveals several striking results. First, all the TRAPPIST-1 planets appear to follow a line of interior isocomposition. There are in fact theoretical mass-radius curves that overlap with all seven planets' mass-radius distributions, which is a good indication that the composition varies little from planet to planet. Secondly, all of the TRAPPIST-1 planets have lower densities than Solar System terrestrial planets. This likely means that the TRAPPIST-1 planets either have a lighter interior (e.g. lower iron content) or are enriched with volatiles (e.g. water).

\begin{figure}
    \centering
    \includegraphics[width=\hsize]{figures/figure_TTV_norm_density_histograms.png}
    \caption{Probability density function of the normalized density of all seven planets in the system. %, superimposed with Gaussian best fit distributions. 
    The normalized densities were calculated by dividing the density of each pair of mass and radius of the TTV/photodynamic posterior distribution by the local density (i.e. of the closest pair of mass and radius) of a planet with an interior composition of 20$\%$ iron and 80$\%$ MgSiO$_3$. A planet with a normalized density of 1 has exactly the same density as a 20$\%$ iron, 80$\%$ MgSiO$_3$ planet. A normalized density ${>}1$ (or ${<}1$, resp.) is denser (or lighter, resp.) than a 20$\%$ iron, 80$\%$ MgSiO$_3$ planet.}
    \label{fig:norm_density_histo}
\end{figure}

We next searched for variations of density across the planets. For this, we normalized each planetary density calculated from $10^4$ samples from the TTV/photodynamic posterior distribution by the local density of a 20$\%$ iron, 80$\%$ silicate (MgSiO$_3$) interior planet \citep{Zeng2016}. For each planetary density (i.e. each pair of mass and radius), the local density was taken to be that of the closest point on the theoretical mass-radius relationship of a 20$\%$ iron, 80$\%$ silicate planet;  we normalized each density by this value. Fig.~\ref{fig:norm_density_histo} shows the resulting histograms of the posterior probability of the normalized TRAPPIST-1 planet densities. We then plotted in Fig.~\ref{fig:norm_density_vs_period} the normalized densities (along with their 1$\sigma$ uncertainty) as a function of the orbital periods of the planets.  The normalized planet density appears very uniform across the seven planets, with perhaps a slight decrease with the increase of the orbital period (or the distance to the host star).  We fit a line to the normalized density, $y$, versus orbital period, $P$, for $10^4$ posterior samples, and found a relation of $y=(1.02\pm 0.03) - (0.0045\pm 0.0035)P$ where the
coefficients are the 68.3\% confidence interval. There is only weak evidence for a declining trend of normalized density with orbital period: 90\% of the slopes have a negative value, while 10\% of the slopes fit have a positive value.  If in the future more precise data strengthen this trend, then
...
\begin{figure}
    \centering
    %\includegraphics[width=\hsize]{figures/figure_density_period_TTV.png}
...
\subsection{Range of possible interior compositions and volatile contents}
 %IN THE PROCESS OF BEING WRITTEN UP BY MARTIN TURBET 
...
and followed by an analysis in which the solid planets are taken to have an Earth-like composition, to which is added a water fraction needed to create the observed densities (\S \ref{sec:volatiles}). The latter is the more likely scenario since planet formation processes easily lead to variable water mass fractions but similar bulk rock compositions with direct implications for core-mass fractions (\S \ref{sec:formation}).  

%{\color{red} We could show a ternary diagram for each planet. However this may be a bit tricky to do for the three inner planets for which water should be in the vapor state.}

%Planets b, c, d and e are consistent with a bare rock/iron terrestrial planet 
%with 20\% iron by mass.  Planets f, g and h have a lower density than 
%that predicted by this mass-radius relation, %which may be a clue that these planets 
%are beyond a condensation line at $\approx$0.025 AU? \citep{Unterborn2018a}.
...
%The rocky interiors can significantly depart from Earth-like compositions \citep[e.g., ][]{Unterborn2018a, dorn2019}. 
If we assume that the planets' atmospheres contribute a negligible
amount to their total radius, and that the planets are composed of rocky mantles (MgSiO$_3$) and iron cores only, then the densities may be used to constrain the portion of the planets' mass which is contained within their cores. Alternatively, it may also be used to constrain the iron mass fraction of the planets as the radius of a planet varies weakly with the distribution of iron in the mantle versus the core \citep{Zeng2013}.
...
Our core mass fraction estimates are provided in Fig~\ref{fig:cmf} and Table~\ref{tab:cmf}.  Estimates range from $9_{-9}^{+11}$\% for planet h up to $22_{-7}^{+5}$\% for planet c, which,  despite the different central values, have considerable overlapping probability distributions.
Fig~\ref{fig:cmf} shows that within the uncertainties, the CMF/Iron fraction of the planets are very consistent with one another, with the mean of all planets of $17_{-4}^{+3}$\% (taking into account the correlations between the planets' core-mass fractions). %This value lies near that of Mars (see Fig~\ref{fig:cmf}), and perhaps indicates that these planets may have formed with a smaller iron abundance than Venus and Earth (or alternatively, with a larger volatile content).

There may be a slight trend of the CMF which decreases with increasing orbital period. The trend is qualitatively similar to that reported on the normalized density (see Fig.~\ref{fig:norm_density_vs_period}), with similarly weak support: only 90\% of the linear fits to the $10^4$ posterior CMF values have a slope with orbital period which is negative, while 10\% are positive.

%{\color{green} 
%  Perhaps
%we should try that out? Caroline? Maybe you want to add a discussion on how to use the most dense planet of the system to study the system?}




% Note:  I think the Zeng et al. (2016) is too crude of a tool
% to estimate the core-mass fraction, and so I would be interested
% in this being revisited with the approach of Dorn et al. (2018)

%The core mass fraction inferred from the mass-radius relation can
%be estimated based on the analytic scaling from \citet{Zeng2016}.
%In Figure \ref{fig:cmf} we show the core-mass fraction inferred
%for the TRAPPIST-1 planets based on the 
%\citet{Zeng2016} relation.  For each mass/radius pair in our
%posterior distribution we have estimated the core-mass fraction,
%and discarded results which are negative (i.e. we assume that
%all seven planets are composed only of rock and iron, with a
%negligible atmosphere).  Table \ref{tab:cmf} gives the
%estimated core-mass fractions, with the mean of all planets
%of $CMF = 0.231\pm 0.034$ (taking into account the correlations
%between the planet's core-mass fractions).  This value lies between that of
%Mars and Venus, and perhaps indicates that these planets may have formed
%with a smaller iron abundance than our solar system planets (or
%there is a larger volatile content).
%The uncertainties for the inner four planets span the range between Mars and Earth, while the 



%\begin{figure}
%    \centering
%    \includegraphics[width=\hsize]{figures/cmf.png}
%    \caption{Core-mass fraction based on the \citet{Zeng2016} analytic
%    estimate versus the planetary orbital periods.  The values for Earth, 
%    Venus and Mars are indicated, as well as the weighted 1-$\sigma$
%    confidence interval of planets
%    b-e (orange), f-h (green), and all seven planets (blue).}
%    \label{fig:cmf}
%\end{figure}

\begin{figure}
    \centering
    %\includegraphics[width=\hsize]{figures/figure_CMF_IRON_CONTENT_PERIOD.png}
    \includegraphics[width=\hsize]{figures/Norm_cmf_vs_period.pdf}
    \caption{Iron mass fraction versus the planetary orbital periods.  The approximate values for Earth \citep{McDonough2014}, Mars \citep{Khan2018}, the Moon \citep{Barr2016}, and common chondrites \citep{Palme2014} are indicated, as well as the 1-$\sigma$ confidence intervals of the TRAPPIST-1 planets. %The iron mass fraction of Venus is approximated by assuming an Earth-like composition model. 
...
%     &  &  &  &   &   &   &   & b-h & b-e & f-h \cr
%      \hline
% CMF [\%] & $22.3 \pm  6.2 $ & $24.4 \pm  5.2 $ & $25.1 \pm  5.0 $ & $26.0 \pm  4.7 $ & $17.8 \pm  3.8 $ & $11.2 \pm  3.8 $ & $22.9 \pm 10.5 $ & $19.9 \pm  2.3 $ & $24.8 \pm  2.7 $ & $ 15.3 \pm  2.8 $ \cr 
%    \end{tabular}
...
%     &  &  &  &   &   &   &   & b-h \cr
      \hline
 CMF [\%] & $22.3_{-6.85}^{+6.85}$ & $24.3_{-7.1}^{+5.1}$ & $14.2_{-6.8}^{+6.1}$ & $20.7_{-5.8}^{+5.8}$ & $16.2_{-5.0}^{+4.4}$ & $11.2_{-4.7}^{+4.7}$ & $9.3_{-9.3}^{+11.4}$ & $17.2_{-4.0}^{+3.4}$ & $20.6_{-4.0}^{+4.5}$ &$12.6_{-4.8}^{+4.8}$  \cr 
    \end{tabular}
    \caption{Core mass fraction inferred for each TRAPPIST-1 planet, as well as the weighted mean.}
    \label{tab:cmf}
\end{table*}

\subsubsection{Volatile content} \label{sec:volatiles}

\begin{figure}
    \centering
    \includegraphics[width=\hsize]{figures/figure_water_period_TTV_trim.png}
    \caption{Theoretical water content (along with 1$\sigma$ error bar) versus planetary orbital periods, for four distinct interior compositions (18, 25, 32.5 and 50\% iron content).}
    \label{fig:water_vs_period}
\end{figure}

The observed variations in the planet densities among all seven planets may instead be due to their different volatile (e.g. water) inventories. 

If we assume a rocky Earth-like interior and only allow an additional {\it condensed}\footnote{It is likely unwarranted to assume condensed water for the inner three planets given their location within the runaway greenhouse zone \citep{Turbet2020}.} water layer to contribute to the total radius, we can estimate the water mass fractions of the seven planets 
(b: 2.8$^{+2.0}_{-2.0}$ \%, c: 2.1$^{+1.7}_{-1.4}$ \%, d: 4.6$^{+2.1}_{-1.5}$ \%, e: 2.9$^{+1.4}_{-1.4}$ \%, f: 4.4$^{+1.8}_{-1.3}$ \%, g: 6.2$^{+2.1}_{-1.6}$  \%, h: 6.0$^{+4.4}_{-3.3}$ \%). 
%(b: 2.5  $\pm$ 2.3  \%, c: 1.9  $\pm$ 1.9 \%, d: 4.4  $\pm$ 2.2 \%, e: 2.5  $\pm$1.9 \%, f: 4.5  $\pm$ 2.0 \%, g: 6.4 $\pm$2.1  \%, h: 5.8  $\pm$ 4.1 \%). 
...
Actual surface conditions can however lead to much larger differences in the estimated water budgets between the inner three and outer four planets. This stems from the fact that the inner three planets are more irradiated than the runaway greenhouse irradiation limit \citep{Kopparapu2013,Wolf2017,Turbet2018} for which all water is vaporized, forming a thick H$_2$O-dominated steam atmosphere. Taking into account the expectation that water should be vaporized for the three inner TRAPPIST-1 planets \citep{Turbet2019,Turbet2020}, their water mass fractions drop drastically to less than $0.01$\%, i.e. more than several times lower than the water ocean mass fraction of the Earth. 

Figure~\ref{fig:water_vs_period} shows the expected water mass fractions for each of the TRAPPIST-1 planets, and for four distinct interior compositions (18, 25, 32.5 and 50\% iron content). It shows that the same trend of water versus orbital period is relatively robust across a large range of assumptions on the interior composition. 

Higher estimated water budgets for the outer three or four planets may be a clue that they formed beyond the water condensation line at $\approx$0.025 AU \citep{Unterborn2018a}. This could also be due to the significant differences in water loss (through atmospheric escape) arising from variations of irradiation and gravity among the TRAPPIST-1 planets \citep{Lissauer2007, Bolmont2017,Bourrier2017}.  However, we caution again that trends in the planetary volatile content are weakly supported by the data.

Another possibility is that the volatiles are contained in the interior of the planets.  For example, if, instead of forming a core, all of the iron is oxidised and remains in the mantle, the size of a planet may increase by a few percent \citep{ElkinsTanton2008}.  If we assume that the refractory ratios match a Solar composition, and that all seven planets lack an atmosphere, then it turns out that all seven planets are consistent with a core-free, oxidized composition (Fig.\ \ref{fig:mass_radius_comparison}).  For this model the bulk mass abundances ratios for Fe/Si/Mg/O are 29.2/17.3/15.3/38.2 wt\%, which is a significant increase in Oxygen compared to the bulk Earth with 29.7 wt\% \citep{McDonough2014}.
...
%{\color{red} We could discuss in the following subsection(s): - how the measured densities compare with various assumed  or modeled compositions. \citep{Schoonenberg2019,Barr2018,Dorn2018,Unterborn2018a,Unterborn2018b} - Is there a correlation of density with escape velocity?  With Safronov number?  With other planet properties?}


\section{Discussion} \label{sec:discussion}

Here we discuss some of the implications of the results in the foregoing sections, and place the planets in the context of exoplanet discoveries and planet formation theories.
...
$\epsilon$, such that the transit depth is given by $(R_p/R_*)^2(1-\epsilon) +
\epsilon$ \citep{Morris2018b,Morris2018c}.  Re-running the Markov chains 
including $\epsilon$ as a free parameter in our fits, we
find that $\epsilon = 0\pm 0.4$\%.  We find no significant impact upon the
inferred planetary radii. 
...
% {\color{red} Emeline Bolmont and Dan Fabrycky:  can we add your
%predictions for the planets' ecccentricities to this plot.  Emeline from 
%Luger et al. 2018, and Dan from your Kepler/K2 Science Conference IV 
%presentation?  Dan, you said one could place constraints on tidal Q' of planet 
%d in your talk.  Also, can we compare with your predicted Laplace angles?
%Does an eighth planet interfere with the predictions for the Laplace angle
%of the outer three planets?}
...
%- Discuss the results in terms of eccentricity magnitude.

%\begin{figure*}
%    \centering
%    \includegraphics[width=\hsize]{figures/ecc_vs_mass_April2019_compare_prior_mixture.png}
%    \caption{Eccentricity vs. mass from the likelihood profile (this is outdated - from April 2019; update
%    with latest analysis).  Thick lines are 1-sigma confidence with longitude prior
%    (approximate anti-alignment of inner two planets' longitudes of periastron). Solid dots
%    are the maximum likelihood without longitude prior.}
%    \label{fig:ecc_vs_mass}
%\end{figure*}
...
to higher order resonances, $P_c/P_b \approx 8/5$, while $P_d/P_c \approx
...
%- Discuss expectation for longitudes of the inner two planets:
%1).  Laplace resonance for the Galilean moons causes the inner two
%moons to be anti-aligned. 2).  Simulations of migration with damping
%predict the inner two should be anti-aligned (Papaloizou, Bolmont,
%Fabrycky). \citep{Papaloizou2017} 3). Minimum energy is for anti-alignment 
%(Malhotra).

%- Discuss the measured orientations of the longitudes of periastron,
%which used to prefer anti-alignment.

%- Discuss results with longitude prior, and how this affects the
%eccentricity amplitudes.
...
\begin{eqnarray}
\phi_{bcd} &=& 2 \lambda_b -5\lambda_c + 3\lambda_d,\cr
\phi_{cde} &=&  \lambda_c -3\lambda_d + 2\lambda_e,\cr
\phi_{def} &=& 2 \lambda_d -5\lambda_e + 3\lambda_f,\cr
\phi_{efg} &=&  \lambda_e -3\lambda_f + 2\lambda_g,\cr
\phi_{fgh} &=&  \lambda_f -2\lambda_g + \lambda_h.
\end{eqnarray}
...
but allowing $bcd$ and $cde$ to be flipped about 180 degrees. 
...
\begin{figure}
    ...
    the values for $\phi_{bcd}$ and $\phi_{cde}$ flipped about
...
We have used the GPU N-body integrator GENGA \cite{Grimm2014} to carry out long-term simulations of a set of $10^4$ samples from the posterior probability distribution of the transit-timing analysis of the system.  These simulations were carried out for $10^7$ years, which corresponds to 2.4 billion orbital periods of planet b, and 2 million orbital periods of planet h. We used a time step of 0.06 days, which gives a total number of $6.1 \cdot 10^{10}$ integration steps. We find that 100\% of these posterior samples are stable over this entire timescale. %Text added by Simon Grimm
...
\begin{figure*}
    \centering
    \includegraphics[width=\hsize]{figures/T1_JWST_all_transits.png}
    \caption{Simulated observations of all of the transits of TRAPPIST-1
    detectable with JWST.  Each transit has an
    uncertainty of $\approx 0.5-1$ seconds, assumed to be observed with
...
\begin{figure}
    \centering
    \includegraphics[width=\hsize]{figures/Recovered_masses_JWST_5yr_all_transits_NIRSPEC.png}
...
about half the precision of our analysis.   We feel that our approach yields a density of superior 
...
We used the luminosity estimate from \citet{Delrez2018b}, which is slightly lower than 
...
We have completed an analysis of the complete set of transit time measurements
of the TRAPPIST-1 planets from the Spitzer Space Telescope, augmented by
additional transits from the ground, K2, and HST.  Our primary conclusions
are:

\begin{enumerate}
    \item  We have measured the masses, radii and densities to high precision, 3-6\%, under the assumption of seven planets.
    \item  The pattern of masses and radii is consistent with a uniform planetary composition for all seven planets,
    which is lower density than the Earth and Venus. This may either be consistent with 
    a core mass fraction of 17\%, or an Earth-like core and mantle with a volatile
    content which varies from ${<}0.01$\% for the inner three planets to ${\approx} 5$\%
    for the outer four.  These are not unique explanations.
    \item  The planets appear to be dynamically-cold, with eccentricities lower than
    $\approx 1$\%, and inclinations which are coplanar to a fraction of a percent.
    \item The system is stable on long timescales, and shows a pattern of GLR with angles which match predictions from migration simulations of \citet{Mah2018}.
    \item We have yet to find strong evidence for an eighth planet.
\end{enumerate}

Based upon these properties, we next speculate on a possible scenario for the formation and evolution of the
system.

\subsection{Expectations for the compositions of the TRAPPIST-1 planets from formation scenarios} \label{sec:formation}

As mentioned, our analysis suggests that the TRAPPIST-1 planets have somewhat lower bulk densities than Earth (see Table \ref{tab:uber_table} and Fig. \ref{fig:mass_radius_relation}) and lower core mass fractions (see Section \ref{sec:subsection_CMF}). One might wonder whether these lower densities result from a deficit of high-density material (e.g., less iron) relative to Earth, or an excess of low-density material (e.g., having more water), or both.

In general, planets formed within the same proto-planetary disk have similar budgets in relative refractory elements \citep{bond2010making,elser2012origin} but can have
very different volatile element budgets \citep{oberg2016excess}. Similar relative refractory elements (Fe, Mg, Si) implies 
similar core mass fractions for all seven planets. As suggested by \citet{Dorn2018}, the rocky interiors analog of a system is best described by studying the densest planet of the system, planet c with 17-30\% CMF. Thus all planets most likely have a 17-30\% CMF with different volatile mass fractions (Fig. 19), which may be increasing with orbital period.

Is an overall CMF of 17-30\% realistic for terrestrial planet interiors? A CMF value of 17-30\% implies lower Fe/Mg and Fe/Si values compared to Earth (and the Sun). Elemental abundances of rocky interiors are expected to be reflected in the photospheric abundance of the host star as argued by \citet{Unterborn2018a} and \citet{Dorn2018}. Unfortunately, measuring the photospheric abundances of this cool and active host star remains very challenging. However, \citet{Unterborn2018a} estimated the stellar Fe/Mg number ratio to be $0.75{\pm} 0.2$ by analysing Sun-like stars of similar metallicity to TRAPPIST-1, which is indeed lower than the Solar value. The corresponding mass-radius curve for a rocky interior of this low Fe/Mg value is plotted in Figure \ref{fig:mass_radius_relation} (brown curve). It overlaps well with the densest planet c. This means, that the stellar abundance estimate supports a possible overall CMF value of 17-30\%.    
...
There are some deficiencies and extensions to our analysis which could be addressed
in future work:
\begin{enumerate}
    ...
    to better measure the amplitude and phase of the transit-timing
    timescale, as well as to better constrain the presence of planets beyond h.
    \item The interpretation of the compositions of the planets is limited by the unknown composition of the host star. A measurement of the $C/O$ ratio would validate the assumption we have made that composition is dominated by silicates rather than silicon carbide.  A measurement of the $Mg/Fe$ and $Fe/Si$ ratios would help to interpret the core composition.  Both sets of constraints would help to limit the range of possible interior compositions of the planets, as well as to break degeneracies in the determination of their compositions \citep{Dorn2015}.
\end{enumerate}

We anticipate that once JWST launches, we will obtain much higher precision constraints upon the dynamics of the system, yielding much improved constraints upon the planets' compositions.
...
Wallonia-Brussels Federation. CD acknowledges the support of the Swiss National Foundation under grant PZ00P2\_174028. V.V.G. is a F.R.S.-FNRS Research Associate. M.G. and E.J. are F.R.S.-FNRS Senior Research Associates. R.M. acknowledges support for this research from NASA (grant 80NSSC18K0397).
...
%\centering
 ...
 \hline
         ...
         \hline
         \input{timings_table_with_sources}
         \hline
 %   \end{tabular}
