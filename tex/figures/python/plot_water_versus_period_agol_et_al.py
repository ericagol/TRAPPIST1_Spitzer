...
ax1.errorbar([-1],[-1],[1], color='silver',alpha=1.0,label=r'50$\%$ iron',lw=2,marker='o',linestyle="none")
...
ax1.errorbar([-1],[-1],[1], color='steelblue',alpha=1.0,label=r'32.5$\%$ iron',lw=2,marker='o',linestyle="none")
...
ax1.errorbar([-1],[-1],[1], color='orange',alpha=1.0,label=r'25$\%$ iron',lw=2,marker='o',linestyle="none")
...
ax1.errorbar([-1],[-1],[1], color='red',alpha=1.0,label=r'18$\%$ iron',lw=2,marker='o',linestyle="none")
...
# THE FOLLOWING LINES WERE SET TO PLOT SEMI-MAJOR AXIS ON TOP Y AXIS (python2.7 style)
#X=np.sqrt((0.01)**3.*(1.510826)**2./(0.01154)**3.)  # t^2/a^3 = cste. constante = np.sqrt((0.01)^3*(1.510826)^2/(0.01154)^3)
#ax1.plot([X,X],[0.338,1.0],color='black',alpha=0.8,lw=0.8)
#X=np.sqrt((0.02)**3.*(1.510826)**2./(0.01154)**3.)  # t^2/a^3 = cste. constante = np.sqrt((0.01)^3*(1.510826)^2/(0.01154)^3)
#ax1.plot([X,X],[0.338,1.0],color='black',alpha=0.8,lw=0.8)
#X=np.sqrt((0.03)**3.*(1.510826)**2./(0.01154)**3.)  # t^2/a^3 = cste. constante = np.sqrt((0.01)^3*(1.510826)^2/(0.01154)^3)
#ax1.plot([X,X],[0.338,1.0],color='black',alpha=0.8,lw=0.8)
#X=np.sqrt((0.04)**3.*(1.510826)**2./(0.01154)**3.)  # t^2/a^3 = cste. constante = np.sqrt((0.01)^3*(1.510826)^2/(0.01154)^3)
#ax1.plot([X,X],[0.338,1.0],color='black',alpha=0.8,lw=0.8)
#X=np.sqrt((0.05)**3.*(1.510826)**2./(0.01154)**3.)  # t^2/a^3 = cste. constante = np.sqrt((0.01)^3*(1.510826)^2/(0.01154)^3)
#ax1.plot([X,X],[0.338,1.0],color='black',alpha=0.8,lw=0.8)
#X=np.sqrt((0.06)**3.*(1.510826)**2./(0.01154)**3.)  # t^2/a^3 = cste. constante = np.sqrt((0.01)^3*(1.510826)^2/(0.01154)^3)
#ax1.plot([X,X],[0.338,1.0],color='black',alpha=0.8,lw=0.8)
#X=np.sqrt((0.07)**3.*(1.510826)**2./(0.01154)**3.)  # t^2/a^3 = cste. constante = np.sqrt((0.01)^3*(1.510826)^2/(0.01154)^3)
#ax1.plot([X,X],[0.338,1.0],color='black',alpha=0.8,lw=0.8)
#X=np.sqrt((0.08)**3.*(1.510826)**2./(0.01154)**3.)  # t^2/a^3 = cste. constante = np.sqrt((0.01)^3*(1.510826)^2/(0.01154)^3)
#ax1.plot([X,X],[0.338,1.0],color='black',alpha=0.8,lw=0.8)

mpl.ylim(1e-6,0.4)
mpl.xlim(0.,20.)
mpl.ylabel(r'Water mass fraction')
mpl.xlabel(r'Period (days)')
mpl.legend(loc=2,numpoints=1)
mpl.semilogy()
