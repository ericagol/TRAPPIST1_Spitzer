...
for p in range(1,6,1):
	...
	if(p == 1):
		...
		#legend
		pl.plot(([0,0]), ([0,0]), lw = 2, c = 'k', label=r"in resonance $d\phi < 45^\circ$")
		pl.plot(([0,0]), ([0,0]), lw = 2, c = 'b', label=r"in resonance $d\phi \ge 45^\circ$")
		pl.plot(([0,0]), ([0,0]), lw = 2, c = 'deepskyblue', label="not in resonance")
		#pl.axis('off')
		ax.legend(loc='upper center', ncol = 3, markerscale=50.0, bbox_to_anchor=(0.5, 1.8), fancybox=True, shadow=True)
	if(p == 2):
...
bincenter, histT1, histT2, histT3, histT4, histT5 =  np.loadtxt("../../../data/Grimm/hist.dat", unpack=True, usecols = (2,3,4,5,6,7))
