...
ax.plot(mgrimm[i]*[1],[0.55],color=cplanet[i],"o")
...
ax.plot((mgrimm[i]-sgrimm1[i])*[1,1],[0.0,1.1],color=cplanet[i],linewidth=2)
ax.plot((mgrimm[i]+sgrimm2[i])*[1,1],[0.0,1.1],color=cplanet[i],linewidth=2)
...
ax.plot(mgrimm[i]*[1],[0.50],color=cplanet[i],"o")
...
ax.plot(mgrimm[i]*[1],[0.60],color=cplanet[i],"o")
