...
#  plot(time,RV[i,:],label=planet_name[i],color=cname[i])
  plot(time,RV[i,:]./100,label=planet_name[i],color=cname[i],alpha=0.5)
#  errorbar([120+10*i],[-1000],Kp[i]*merror[i]/mavg[i],color=cname[i])
  errorbar([100+10*i],[-11],Kp[i]*merror[i]/mavg[i]/100,color=cname[i])
end
#text(40,-1020,"Equivalent RV precision:",fontsize=10)
text(5,-11.20,"Equivalent RV precision:",fontsize=10)
text(180,-11.2,"Measured RV precision: ")
