...
better describes the {residual distribution}:  %a mixture model \citep{Hogg2010,ForemanMackey2014} and
...
\begin{figure}
    ...
    {Normalized planet densities (with 1$\sigma$ error-bars) versus planet orbital periods. The light blue band is the 68\% confidence interval of the weighted mean normalized density of all seven planets.  The orange lines show the 68.3\% confidence intervals of linear fits to the normalized densities computed from $10^4$
        draws from the posterior.  The mean fit to the normalized density versus period is {$y = a P + b$ where $\mathbf{a= 1.042{\pm}0.034}$ and $\mathbf{b=-0.0043{\pm}0.0036}$.}}
...
Our core mass fraction estimates are provided in Fig~\ref{fig:cmf} and Table~\ref{tab:cmf}.  Estimates range from {$\mathbf{16.1_{-4.2}^{+3.5}}$ wt\% for planet g up to $\mathbf{26.6_{-5.1}^{+4.6}}$ wt\% for planet c}, which,  despite the different central values, have considerable overlapping probability distributions.
Fig~\ref{fig:cmf} shows that within the uncertainties, the CMF/Iron fraction of the planets are very consistent with one another, with the mean of all planets of {$\mathbf{21{\pm}4}$} wt\% (taking into account the correlations between the planets' core-mass fractions).
...
\begin{figure*}
    \centering
    \includegraphics[width=0.6\hsize]{figures/figure_water_period_TTV_trim.png}
...
\begin{enumerate}
    ...
    \item  The pattern of masses and radii {may be} consistent with a uniform planetary composition for all seven planets
          ...
          a core mass fraction of $\mathbf{21{\pm}4}$ {wt\%}, or an Earth-like core and mantle with a {surface water}
