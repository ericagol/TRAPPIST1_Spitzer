...
Fe/Mg molar ratio &  $0.60_{-0.18}^{+0.18}$ & $0.64_{-0.16}^{+0.16}$ & $0.44_{-0.13}^{+0.14}$ & $0.58_{-0.14}^{+0.14}$ & $0.45_{-0.11}^{+0.10}$ & $0.34_{-0.10}^{+0.09}$ & $0.35_{-0.23}^{+0.27}$ & $0.47\pm0.07$ \cr
    ...
    \end{tabular}
    \caption{Core mass \textbf{fractions and molar Fe/Mg ratio (for a fully-differentiated model), and water mass fractions} inferred for each TRAPPIST-1 planet, as well as the weighted means.}
    \label{tab:cmf}
\end{table*}}
