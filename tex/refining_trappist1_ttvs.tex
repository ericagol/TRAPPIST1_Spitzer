...
For each planet a fixed time of transit for epoch zero ($T_{0}$) and fixed period ($P$) were used \textbf{\citep[given in][]{Ducrot2020}}, but with timing offset (``TTV") as a fitted parameter for each transit as described by \cite{Ducrot2020}.  The timing offsets are added back
...
Julia \citep{Benzanson2017}, Limbdark.jl \citep{Agol2020}.}}
