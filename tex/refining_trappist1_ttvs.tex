...
more realistic limb-darkening models \citep{Claret2018} and found that a quadratic law
was sufficient to recover the correct model parameters with negligible systematic errors.}
