...
CMF [wt\%] &  $25.2_{- 6.0}^{+ 5.3}$ & $26.6_{- 5.1}^{+ 4.6}$ & $19.7_{- 5.1}^{+ 4.7}$ & $24.6_{- 4.9}^{+ 4.3}$ & $20.1_{- 4.2}^{+ 3.5}$ & $16.1_{- 4.2}^{+ 3.5}$ & $16.5_{-10.0}^{+ 9.3}$ & $20.9{\pm}3.6$ \cr
    ...
    \end{tabular}
    \caption{Core mass \textbf{fractions and water mass fractions} inferred for each TRAPPIST-1 planet, as well as the weighted means.}
    \label{tab:cmf}
\end{table*}}
