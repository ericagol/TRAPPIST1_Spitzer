...
\end{equation}
which is the characteristic timescale of the transit timing variations (TTVs) \bf{of
...
days (ranging from \bf{485 to 500} days for each pair).  This timescale has two consequences for
