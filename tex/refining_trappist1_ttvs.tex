...
\textbf{so that our set of model parameters $\mathbf{x} = (\mathbf{x}_{dyn},\log \nu, V_1 e^{1/2\nu})$.} 
...
two-temperature model with the temperatures of the two components ranging from 2000-2980 K 
...
the bands between the effective temperature grid points which were spaced by 20 K. We then computed 
the expected impact on the transit depths in the two IRAC channels.  The constraints are tight: we 
find that the observed depths should only change by a factor of $0.9979{\pm}0.0024$ in Channel 1 
and $0.9973{\pm}0.0030$ in Channel 2.  These factors are consistent with unity within the 
uncertainties, and have uncertainties which are much smaller than the uncertainties on the 
absolute planetary radii. We conclude that this form of self-contamination does not influence 
our results.  This constraint is much stronger than the analysis of \citet{Morris2018c}.}
