...
model.  Each transit time is measured as a Barycentric Julian Date (BJD$_\mathrm{TDB}$), correcting for the location of the Earth/spacecraft relative to the Solar System barycenter \citep{Eastman2010}.
